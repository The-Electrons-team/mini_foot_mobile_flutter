...
const _teamColors = [
  ...
  Color(0xFF004D40), Color(0xFF006F39), Color(0xFF33691E), Color(0xFF827717),
  Color(0xFFF57F17), Color(0xFFFF6F00), Color(0xFFE65100), Color(0xFFBF360C),
  Color(0xFF3E2723), Color(0xFF212121), Color(0xFF263238), Color(0xFF000000),
  Color(0xFF1B5E20), Color(0xFF4E342E), Color(0xFF8D6E63), Color(0xFF757575),
  Color(0xFF00838F), Color(0xFF2E86AB), Color(0xFFD84315),
];
...
class _CreateTeamScreenState extends State<CreateTeamScreen> {
  ...
  String _determineZone(LatLng? location, String address) {
    if (location == null) return 'DAKAR';
    final lowerAddress = address.toLowerCase();
    if (lowerAddress.contains('keur massar') || lowerAddress.contains('yeumbeul') || lowerAddress.contains('malika')) return 'KEUR_MASSAR';
    if (lowerAddress.contains('pikine') || lowerAddress.contains('mbao') || lowerAddress.contains('thiaroye')) return 'PIKINE';
    if (lowerAddress.contains('guediawaye') || lowerAddress.contains('guédiawaye')) return 'GUEDIAWAYE';
    if (lowerAddress.contains('rufisque') || lowerAddress.contains('bargny') || lowerAddress.contains('diamniadio')) return 'RUFISQUE';
    
    if (location.longitude > -17.34) return 'RUFISQUE';
    if (location.latitude > 14.77 && location.longitude > -17.38) return 'KEUR_MASSAR';
    if (location.latitude > 14.75 && location.longitude < -17.40) return 'GUEDIAWAYE';
    if (location.latitude > 14.73 && location.longitude > -17.42) return 'PIKINE';
    return 'DAKAR';
  }
  ...
  Future<void> _create() async {
    ...
    try {
      ...
      await teamProv.createTeam(
        ...
        name: name,
        zone: _determineZone(_location, _address),
        address: _address,
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Equipe cree avec succes !')),
        );
        ...
        Expanded(child: ListView(padding: const EdgeInsets.fromLTRB(20, 8, 20, 32), children: [
          ...
          Container(padding: const EdgeInsets.symmetric(horizontal: 4, vertical: 2),
            decoration: BoxDecoration(color: _card(context), borderRadius: BorderRadius.circular(14),
                border: Border.all(color: _nameError ? Colors.red.shade300 : _sub(context).withOpacity(0.15))),
          ...
          Row(children: [
            Expanded(child: GestureDetector(onTap: _locating ? null : _useGPS,
              child: Container(padding: const EdgeInsets.symmetric(vertical: 12),
                decoration: BoxDecoration(color: _kGreen.withOpacity(0.08), borderRadius: BorderRadius.circular(12),
          ...
          if (_location != null)
            Container(padding: const EdgeInsets.all(12),
              decoration: BoxDecoration(color: _kGreen.withOpacity(0.07), borderRadius: BorderRadius.circular(12),
            ...
            Container(padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 10),
              decoration: BoxDecoration(color: _sub(context).withOpacity(0.06), borderRadius: BorderRadius.circular(12)),
              child: Row(children: [
          ...
          GestureDetector(onTap: _isSubmitting ? null : _create,
            child: Container(width: double.infinity, padding: const EdgeInsets.symmetric(vertical: 15),
              decoration: BoxDecoration(color: _isSubmitting ? _kGreen.withOpacity(0.5) : _kGreen, borderRadius: BorderRadius.circular(16)),
              child: _isSubmitting 
                ? const Center(child: SizedBox(width: 20, height: 20, child: CircularProgressIndicator(color: Colors.white, strokeWidth: 2)))
                : const Text('Creer l equipe', textAlign: TextAlign.center,
    ...
    return Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Row(children: [
          AnimatedContainer(duration: const Duration(milliseconds: 100), width: 52, height: 52,
            decoration: BoxDecoration(color: _current, shape: BoxShape.circle,
                boxShadow: [BoxShadow(color: _current.withOpacity(0.5), blurRadius: 12)])),
          const SizedBox(width: 14),
        ...
        SliderTheme(data: SliderTheme.of(context).copyWith(trackHeight: 10,
          ...
          overlayShape: const RoundSliderOverlayShape(overlayRadius: 18),
          activeTrackColor: _current, inactiveTrackColor: _sub(context).withOpacity(0.15), thumbColor: Colors.white),
